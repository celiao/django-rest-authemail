...
urlpatterns = [
    ...
    path('email/change/', views.EmailChangeView.as_view(),
        name='email_change_page'),
    path('email/change/emails_sent/',
        views.EmailChangeEmailsSentView.as_view(),
        name='email_change_emails_sent_page'),
    path('email/change/verify/', views.EmailChangeVerifyView.as_view()),
    path('email/change/verified/',
        views.EmailChangeVerifiedView.as_view(),
    ...
    path('password/change/success/', views.PasswordChangeSuccessView.as_view(),
